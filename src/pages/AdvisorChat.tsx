...
import { Compass, Sparkles, Send, Loader2, CheckCircle2, User } from 'lucide-react';
...
export const AdvisorChat: React.FC = () => {
  ...
  const loadChatHistory = async () => {
    ...
    if (history.length === 0) {
      // Welcome message from Chief of Staff
      const initialMessage: ChatMessage = {
        id: 'msg-welcome',
        role: 'assistant',
        content: "I'm your AI Academic Chief of Staff. You can talk to me about upcoming quizzes, assignments you've finished, or subjects you're struggling with. I will automatically manage your academic memory and update your daily study plan.",
      };
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      // Process chat with AI Chief of Staff and entity extraction
      ...
      const aiMsg: ChatMessage = {
        ...
        metadata: actionSummary ? { actionSummary } : undefined,
      };
            ...
            <div className="space-y-4 overflow-y-auto max-h-[500px] pr-2 flex-1">
                  ...
                  >
                    ...
                    <div className="space-y-1.5 max-w-[85%]">
                      ...
                      {msg.metadata?.actionSummary && (
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-emerald-950/80 border border-emerald-800/60 text-emerald-300 text-[11px] font-medium">
              ...
              {loading && (
                <div className="flex gap-3 justify-start">
                  ...
                  <div className="p-4 rounded-2xl text-sm bg-black border border-zinc-800 text-zinc-400 animate-pulse">
                    Parsing academic intent & updating memory...
                  </div>
                </div>
              )}
            ...
            <form onSubmit={handleSendMessage} className="pt-4 border-t border-zinc-800/80 mt-4 space-y-2">
              <div className="relative">
                <input
                  ...
                  placeholder="e.g. 'I have a chemistry quiz Friday', 'I finished my essay'..."
              ...
              <div className="flex items-center justify-between text-[11px] text-zinc-500 px-1">
                <span>Statements automatically update your tasks, exams & daily mission</span>
