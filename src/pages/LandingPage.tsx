...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500 selection:text-white relative overflow-hidden">
      {/* Subtle Background Glows (Apple/Linear style) */}
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-xs font-semibold bg-white hover:bg-slate-200 text-slate-950 px-4 py-2 rounded-lg transition-all shadow-md hover:shadow-indigo-500/10"
            >
              Start Free
            </button>
          </div>
      ...
      <section className="pt-24 pb-20 px-6 max-w-5xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900 border border-slate-800 text-slate-300 text-xs font-medium mb-8 backdrop-blur-sm">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          ...
          <a
            href="#how-it-works"
            className="w-full sm:w-auto px-8 py-4 bg-slate-900 hover:bg-slate-800 text-slate-200 text-sm font-semibold rounded-xl border border-slate-800 transition-all flex items-center justify-center gap-2"
          >
        ...
        <div className="relative max-w-3xl mx-auto rounded-2xl p-1 bg-gradient-to-b from-slate-700/50 via-slate-800/30 to-slate-900/50 shadow-2xl border border-slate-800 backdrop-blur-xl">
          <div className="bg-slate-950/90 rounded-[14px] p-6 sm:p-8 text-left border border-slate-800/60">
            {/* Header bar */}
            <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-slate-500 font-mono ml-2">Today's Priority Matrix</span>
              </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-slate-900/80 rounded-xl border border-indigo-500/30 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-indigo-400" />
                  <div>
                    <h4 className="text-sm font-semibold text-white">CS 101: Review Binary Trees & Recursion</h4>
                    <p className="text-xs text-slate-400">High priority • Exam in 3 days</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-xs text-slate-400 bg-slate-800/60 px-2.5 py-1 rounded-lg">
                  <Clock className="w-3.5 h-3.5 text-indigo-400" />
                  <span>45 mins</span>
                </div>
              </div>

              <div className="p-4 bg-slate-900/40 rounded-xl border border-slate-800/60 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-slate-600" />
                  <div>
                    <h4 className="text-sm font-medium text-slate-300">MATH 202: Problem Set 4 (Odd Numbers)</h4>
                    <p className="text-xs text-slate-500">Medium priority • Due Thursday</p>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-xs text-slate-500 bg-slate-900 px-2.5 py-1 rounded-lg">
      ...
      <section id="how-it-works" className="py-24 px-6 max-w-5xl mx-auto border-t border-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-slate-900/40 border border-slate-800 p-8 rounded-2xl hover:border-indigo-500/30 transition-all group">
            <div className="w-12 h-12 rounded-xl bg-indigo-600/10 border border-indigo-500/20 text-indigo-400 flex items-center justify-center mb-6 group-hover:scale-105 transition-transform">
      ...
      {/* BENEFITS SECTION */}
      <section id="benefits" className="py-24 px-6 max-w-5xl mx-auto border-t border-slate-900">
        <div className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-slate-900/50 border border-slate-800/80 p-8 rounded-2xl backdrop-blur-xl">
      ...
      {/* FAQ SECTION */}
      <section id="faq" className="py-24 px-6 max-w-3xl mx-auto border-t border-slate-900">
        <div className="text-center mb-16">
      ...
      {/* CTA SECTION */}
      <section className="py-24 px-6 max-w-5xl mx-auto border-t border-slate-900 text-center">
        <div className="bg-gradient-to-b from-indigo-950/40 via-slate-900/80 to-slate-950 border border-indigo-500/20 p-12 sm:p-16 rounded-3xl backdrop-blur-2xl relative overflow-hidden">
          ...
          <button
            onClick={() => openAuthModal(true)}
            className="px-8 py-4 bg-white hover:bg-slate-200 text-slate-950 font-semibold text-sm rounded-xl shadow-xl transition-all inline-flex items-center gap-2"
          >
            <span>Start Free</span>
      ...
      {isAuthOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-in fade-in duration-200">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-md w-full p-6 sm:p-8 relative shadow-2xl">
            {/* Close button */}
            <button
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-4 py-2.5 bg-slate-950/80 border border-slate-800 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                    />
                  </div>
                </div>
              )}
