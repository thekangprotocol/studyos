...
import { Compass, LogOut, User, LayoutDashboard, MessageSquare, Settings } from 'lucide-react';
 ...
 * Displays StudyOS pitch black brand title, navigation tabs (Today's Mission vs Chief of Staff Chat), settings, and user logout.
 */
              ...
              {user && (
                <div className="flex items-center gap-2.5 pl-3 border-l border-zinc-900">
                  <button
                    ...
                    className="flex items-center gap-2 text-xs text-zinc-300 hover:text-white bg-zinc-900/80 hover:bg-zinc-800 px-3 py-1.5 rounded-lg border border-zinc-800 transition-colors"
